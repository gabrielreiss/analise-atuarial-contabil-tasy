...
SUM(T5.VL_LIBERADO) VL_LIBERADO,
SUM(T5.VL_GLOSA) VL_GLOSA,
SUM(T5.VL_COPARTICIPACAO) VL_COPARTICIPACAO,
SUM(T5.VL_PROCEDIMENTO) VL_PROCEDIMENTO,
SUM(T5.VL_TOTAL_PROCEDIMENTO) VL_TOTAL_PROCEDIMENTO
--T1.NR_SEQ_PROTOCOLO,
--T1.NR_SEQ_PLANO,
--T2.NR_SEQ_PRESTADOR,
--T5.NR_SEQ_CONTA,
...
LEFT JOIN Tasy.CONTA_CONTABIL T9 ON T9.CD_CONTA_CONTABIL = T5.CD_CONTA_DEB
