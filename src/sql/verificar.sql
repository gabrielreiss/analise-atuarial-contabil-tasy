...
T5.CD_PROCEDIMENTO,
T5.CD_CONTA_DEB,
T5.VL_TOTAL_PROCEDIMENTO

--T1.*, T2.*, T3.*, T4.*, T5.*, T6.*, T7.*

FROM Tasy.PLS_CONTA T1

LEFT JOIN Tasy.PLS_PROTOCOLO_CONTA T2   ON T2.NR_SEQUENCIA = T1.NR_SEQ_PROTOCOLO
LEFT JOIN Tasy.PLS_PLANO T3             ON T3.NR_SEQUENCIA = T1.NR_SEQ_PLANO
