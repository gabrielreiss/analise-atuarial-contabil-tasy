...
#exportar_csv('pic')
#exportar_csv('competencia_TISS')
#exportar_csv('mensalidade_ind')
#exportar_csv('por_modalidade')
#exportar_csv('contas_contabil')
#exportar_csv('contas_contabil_despesa')
#exportar_csv('despesas_assistenciais_produto')
#exportar_csv('despesas_assistenciais_modalidade')
#exportar_csv('Falta_CBO_Verte')
#exportar_csv('Falta_CBO_Verte_dados')
#exportar_csv('contas_medicas_contabil')
#exportar_csv_grande('verificar')
#exportar_csv('procedimentos')
#exportar_csv('materiais')
#exportar_csv('contabil_historico')
#exportar_csv('verificar_lancamentos')
#exportar_csv('s2')
exportar_csv('verte_sede_procedimentos')
exportar_csv('verte_sede_alocacao_reembolso')
exportar_csv('verte_sede_alocacao_reembolso_agrupado')